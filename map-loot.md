...
These files control how buildings are assigned loot slots, where those buildings sit on the map, and how loot clusters are grouped.
...
> **Path:** `dayzxb_missions/dayzOffline.<mapname>/` (Xbox) · `dayzps_missions/…` (PlayStation)
